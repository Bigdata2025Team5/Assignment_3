...
def fetch_and_upload_co2_data():
    ...
    file_name = f"co2_data_{current_date}.txt"

    try:
        # Upload the data to S3
        s3.put_object(Bucket=BUCKET_NAME, Key=file_name, Body=data)
        print(f"Data successfully uploaded to S3 bucket '{BUCKET_NAME}' as '{file_name}'")
    except Exception as e:
        print(f"An error occurred: {str(e)}")

if __name__ == "__main__":
    fetch_and_upload_co2_data()
